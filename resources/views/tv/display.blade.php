...
<head>
    ...
    <style>
        ...
        /* ATR: aquí la cabecera tiene alto fijo (--header-height): la sigla y la fecha se miden con ese alto para que quepan */
        .tv-unidad h1 { font-size: calc(var(--header-height) * .36) !important; margin-bottom: 0 !important; }
        .tv-fecha { font-size: calc(var(--header-height) * .16) !important; line-height: 1.35 !important; }
    ...
    <script>
        ...
        function loadNewMedia(media, container) {
            ...
            if (media.tipo === 'imagen') {
                ...
                prepararPieza(video, 'loadeddata');
                video.autoplay = true;
                video.muted = true;
                video.loop = false;
